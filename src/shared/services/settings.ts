...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      name: 'evolink',
      title: 'EvoLink',
      description: `Custom <a href="https://docs.evolink.ai/en/api-manual/language-series/claude/claude-messages-api" class="text-primary" target="_blank">EvoLink Claude Messages API</a> settings`,
      tab: 'ai',
    },
    {
      name: 'adsense',
...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    {
      name: 'evolink_direct_base_url',
      title: 'EvoLink Direct Base URL',
      type: 'url',
      placeholder: 'https://direct.evolink.ai',
      group: 'evolink',
      tab: 'ai',
      tip: 'Use the direct URL for long-running Claude requests.',
    },
    {
      name: 'evolink_model',
      title: 'EvoLink Model',
      ...
      group: 'evolink',
      tab: 'ai',
      tip: 'Example: claude-haiku-4-5-20251001',
    },
    {
      name: 'adsense_code',
      title: 'Adsense Code',
